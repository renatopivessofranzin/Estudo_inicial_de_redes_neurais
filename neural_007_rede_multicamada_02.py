...
# Descrição da Aplicação: Implementação rede com 3 camadas ocultas
# Data: 08/01/2021
...
pesosEntrada = 2*np.random.random((2,6)) - 1 # Matriz 2x3 (valores: -1 a +1)
pesosOculta_1 = 2*np.random.random((6,6)) - 1 # Matriz 3x3 (valores: -1 a +1)
pesosOculta_2 = 2*np.random.random((6,6)) - 1 # Matriz 3x3 (valores: -1 a +1)
pesosOculta_3 = 2*np.random.random((6,1)) - 1 # Matriz 3x1 (valores: -1 a +1)
